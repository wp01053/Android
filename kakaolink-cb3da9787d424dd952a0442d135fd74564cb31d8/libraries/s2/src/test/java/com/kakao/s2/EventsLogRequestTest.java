...
public class EventsLogRequestTest extends KakaoTestCase {
    ...
    private RequestConfiguration appConfig = new RequestConfiguration("sample_app_key", "client_secret","sample_key_hash", "sample_ka_header","sample_app_ver", "sample_package_name", "extras");
//    private com.kakao.network.RequestConfiguration configuration =  new com.kakao.network.RequestConfiguration(appConfig, , "sample_extras");
