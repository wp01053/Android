...
public class FriendsService {
     ...
     *  1) Registered to this app (Connect with Kakao)
     *  2) Agreed to provide friends info to this app
     *
     ...
     *
     * This API will return an error if this Kakao account user does not user KakaoTalk.
     *
