...
public interface KakaoLinkCore {
     ...
     */
    Uri sharerUri(final Context context, final TemplateParams params);
     ...
     * @return {@link Uri} instance representing the sharer URL
     */
    Uri sharerUri(final Context context, final String templateId, final Map<String, String> templateArgs);
     ...
     */
    @SuppressWarnings("unused")
    Uri sharerUri(final Context context, final String url);
     ...
     * @return {@link Uri} instance representing the sharer URL
     */
    Uri sharerUri(final Context context, final String url, final String templateId, final Map<String, String> templateArgs);
    ...
    class Factory {
        ...
        private static KakaoLinkCore service = new DefaultKakaoLinkCore(KakaoUtilService.Factory.getInstance());
    }
}
