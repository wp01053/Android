...
import com.kakao.auth.mocks.TestKakaoUtilService;
...
public class AuthCodeParseIntentTest extends KakaoTestCase {
    ...
    private RequestConfiguration appConfig = new RequestConfiguration(appKey, "client_secret","key_hash", "ka_header", "app_ver", "package_name", "extras");
    ...
    public void setup() {
        ...
        talkAuthCodeService = new TalkAuthCodeService(context, appConfig, sessionConfig, utilService);
    }
