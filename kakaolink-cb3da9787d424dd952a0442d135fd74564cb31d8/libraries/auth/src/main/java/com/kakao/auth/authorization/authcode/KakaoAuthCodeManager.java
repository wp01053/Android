...
class KakaoAuthCodeManager implements AuthCodeManager, AuthCodeListener {
    ...
    KakaoAuthCodeManager(final CurrentActivityProvider activityProvider, final IConfiguration appConfig, final ISessionConfig sessionConfig, final AuthCodeService kakaoManager, final AuthCodeService storyManager, final AuthCodeService webManager) {
