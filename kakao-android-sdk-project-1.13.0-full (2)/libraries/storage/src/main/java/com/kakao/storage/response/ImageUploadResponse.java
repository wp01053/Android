...
import com.kakao.network.response.ResponseBodyException;
...
public class ImageUploadResponse extends JSONObjectResponse {
    ...
    public ImageUploadResponse(ResponseData responseData) throws ResponseBodyException, ApiResponseError {
        super(responseData);
