...
public interface AuthCodeManager {
    ...
    class Factory {
        ...
        public static AuthCodeManager initialize(final Application application, final IConfiguration appConfig, final ISessionConfig sessionConfig) {
            if (authCodeManager == null) {
                AuthCodeService talkManager = AuthCodeService.Factory.createTalkService(application, appConfig, sessionConfig, KakaoUtilService.Factory.getInstance());
                AuthCodeService storyManager = AuthCodeService.Factory.createStoryService(application, appConfig, sessionConfig, KakaoUtilService.Factory.getInstance());
                ...
                authCodeManager = new KakaoAuthCodeManager(CurrentActivityProvider.Factory.getInstance(), appConfig, sessionConfig, talkManager, storyManager, webManager);
            }
